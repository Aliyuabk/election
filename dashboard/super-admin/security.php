    ...
    try {
        switch ($action) {
            ...
            case 'enable_2fa':
                ...
                $stmt->execute([$two_factor_enabled, $user_id]);
...
<style>
    /* ============================================================
       SECURITY - PRO STYLES
       ============================================================ */
    .security-container { max-width: 900px; margin: 0 auto; }
    ...
    .security-card { background: white; border-radius: var(--radius); border: 1px solid var(--gray-200); padding: 28px 32px; box-shadow: var(--shadow); margin-bottom: 20px; }
    .security-card .card-title { font-weight: 600; font-size: 1rem; margin-bottom: 4px; display: flex; align-items: center; gap: 8px; }
    .security-card .card-title i { color: var(--primary); }
    .security-card .card-desc { color: var(--gray-500); font-size: 0.85rem; margin-bottom: 20px; }
    ...
    .form-group .checkbox-group .badge-2fa { background: var(--secondary); color: white; padding: 1px 10px; border-radius: 12px; font-size: 0.6rem; font-weight: 600; margin-left: 6px; }
    .form-group .checkbox-group .badge-2fa.disabled { background: var(--gray-400); }
    ...
    .form-actions .btn-danger { background: var(--danger); color: white; }
    .form-actions .btn-danger:hover { background: #DC2626; }
    
    .session-item { display: flex; justify-content: space-between; align-items: center; padding: 12px 0; border-bottom: 1px solid var(--gray-100); }
    .session-item:last-child { border-bottom: none; }
    .session-item .session-info { display: flex; flex-direction: column; gap: 2px; }
    .session-item .session-info .device { font-weight: 500; font-size: 0.85rem; }
    .session-item .session-info .details { font-size: 0.75rem; color: var(--gray-400); }
    .session-item .session-status { display: flex; align-items: center; gap: 8px; }
    .session-item .session-status .badge-active { background: #ECFDF5; color: #065F46; padding: 2px 12px; border-radius: 20px; font-size: 0.65rem; font-weight: 600; }
    .session-item .session-status .badge-active i { font-size: 6px; margin-right: 4px; }
    .session-item .session-status .badge-inactive { background: var(--gray-100); color: var(--gray-500); padding: 2px 12px; border-radius: 20px; font-size: 0.65rem; font-weight: 600; }
    
    .event-item { display: flex; align-items: flex-start; gap: 12px; padding: 10px 0; border-bottom: 1px solid var(--gray-100); }
    .event-item:last-child { border-bottom: none; }
    .event-item .event-icon { width: 32px; height: 32px; border-radius: 8px; display: flex; align-items: center; justify-content: center; font-size: 0.8rem; flex-shrink: 0; }
    ...
    .event-item .event-content .desc { font-size: 0.82rem; }
    .event-item .event-content .time { font-size: 0.7rem; color: var(--gray-400); }
    .event-item .event-content .ip { font-size: 0.7rem; color: var(--gray-400); font-family: monospace; }
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        <div class="security-container">
            ...
            <div class="security-card">
                <div class="card-title"><i class="fas fa-mobile-alt"></i> Two-Factor Authentication</div>
            ...
            <!-- Active Sessions -->
            <div class="security-card">
                <div class="card-title"><i class="fas fa-laptop"></i> Active Sessions</div>
                <div class="card-desc">Manage your active sessions across devices.</div>
                                ...
                                <?php if ($session['is_active']): ?>
                                    ...
                                    <?php if ($session['token'] !== SessionManager::get('session_token')): ?>
                                        <form method="POST" style="display:inline;">
                                            ...
                                            <button type="submit" class="btn-sm danger" style="padding:4px 10px;font-size:0.7rem;border-radius:6px;border:none;cursor:pointer;background:#FEF2F2;color:#991B1B;transition:var(--transition);">
                ...
                <?php else: ?>
                    <div style="text-align:center;padding:20px;color:var(--gray-500);">
                        <i class="fas fa-laptop" style="font-size:2rem;display:block;margin-bottom:8px;color:var(--gray-300);"></i>
            ...
            <!-- Security Events -->
            <div class="security-card">
                <div class="card-title"><i class="fas fa-history"></i> Security Events</div>
                <div class="card-desc">Recent security events on your account.</div>
                ...
                <?php else: ?>
                    <div style="text-align:center;padding:20px;color:var(--gray-500);">
                        <i class="fas fa-shield-alt" style="font-size:2rem;display:block;margin-bottom:8px;color:var(--gray-300);"></i>
