<?php
// ============================================================
// ELECTION TEMPLATES - SUPER ADMINISTRATOR
// ============================================================
...
<style>
    ...
    .template-card .card-actions .btn-sm.purple {
        background: #F5F3FF;
        color: #8B5CF6;
    }
    .template-card .card-actions .btn-sm.purple:hover {
        background: #EDE9FE;
    }
    .template-card .card-actions .btn-sm.blue {
        background: #EFF6FF;
        color: #3B82F6;
    }
    .template-card .card-actions .btn-sm.blue:hover {
        background: #DBEAFE;
    }
    .template-card .card-actions .btn-sm.green {
        background: #ECFDF5;
        color: #10B981;
    }
    .template-card .card-actions .btn-sm.green:hover {
        background: #D1FAE5;
    }
    .template-card .card-actions .btn-sm.outline {
        background: transparent;
        color: var(--gray-500);
        border: 1px solid var(--gray-200);
    }
    .template-card .card-actions .btn-sm.outline:hover {
        background: var(--gray-50);
        border-color: var(--gray-300);
    }
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="page-header">
            <div>
                <h2>
                    <i class="fas fa-copy" style="color:#8B5CF6;margin-right:8px;"></i> Election Templates
        ...
        <div class="templates-grid">
            ...
            <div class="template-card">
                ...
                <div class="template-meta">
                    ...
                    <span><i class="fas fa-map-marker-alt"></i> 176,846 PUs</span>
                </div>
            ...
            <div class="template-card">
                ...
                <div class="card-actions">
                    <a href="elections-create.php?template=house_of_reps" class="btn-sm orange" style="background:#FFFBEB;color:#F59E0B;">
                        <i class="fas fa-plus"></i> Use Template
                    </a>
                    <a href="#" class="btn-sm outline">
                        <i class="fas fa-eye"></i> Preview
            ...
            <div class="template-card">
                ...
                <div class="card-actions">
                    <a href="elections-create.php?template=lga_chairman" class="btn-sm red" style="background:#FEF2F2;color:#EF4444;">
                        <i class="fas fa-plus"></i> Use Template
                    </a>
                    <a href="#" class="btn-sm outline">
                        <i class="fas fa-eye"></i> Preview
            ...
            <div style="display:flex;align-items:flex-start;gap:12px;">
                ...
                <div>
                    ...
                    <p style="color:var(--gray-500);font-size:0.85rem;">
                        ...
                        <a href="elections-create.php" style="color:#8B5CF6;text-decoration:none;font-weight:500;">Create from scratch →</a>
                    </p>
                </div>
            </div>
        </div>
