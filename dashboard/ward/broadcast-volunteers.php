...
// ============================================================
// HANDLE BROADCAST TO VOLUNTEERS
// ============================================================
$success_message = '';
$error_message = '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($message)) {
        ...
        try {
            // Get volunteers only
            $recipients = getBroadcastRecipients($tenant_id, 'volunteers', [], $ward_id);
            $total_recipients = count($recipients);
            
            if ($total_recipients == 0) {
                $error_message = "No volunteers found in this ward.";
            } else {
                // Insert broadcast
                ...
                $stmt = $db->prepare("
                    ...
                    ) VALUES (?, ?, ?, ?, 'volunteers', ?, 'sent', ?, NOW(), NOW())
                ");
                ...
                logActivity($user_id, 'broadcast_volunteers', "Sent broadcast to Volunteers: $title ($total_recipients recipients)", 'broadcasts', $broadcast_id);
                
                $success_message = "Broadcast sent to $total_recipients Volunteers successfully!";
            ...
            error_log("Broadcast Volunteers error: " . $e->getMessage());
        }
    }
}
