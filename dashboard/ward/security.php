<?php
// ============================================================
// WARD COORDINATOR - SECURITY SETTINGS
// ============================================================
    ...
    <div class="main-content-inner">
        <div class="security-container">
            ...
            <div class="welcome-section">
                <div>
                    ...
                    <p class="subtitle">
                        ...
                        <?php echo htmlspecialchars($ward_name); ?> Ward - Security Settings
                    </p>
                </div>
            </div>
                ...
                <?php if (!empty($active_sessions)): ?>
                    ...
                    <div style="margin-top:8px;">
                        <form method="POST" action="" style="display:inline;">
                            ...
                            <button type="submit" class="btn-danger" onclick="return confirm('Revoke all other sessions?')" style="padding:4px 14px;font-size:0.7rem;border-radius:6px;">
                                <i class="fas fa-sign-out-alt"></i> Revoke All Others
                            </button>
                        </form>
                    </div>
                <?php else: ?>
                    <div style="text-align:center;padding:12px;color:var(--gray-400);font-size:0.85rem;">
                        <i class="fas fa-desktop" style="display:block;font-size:1.2rem;margin-bottom:4px;"></i>
                        No active sessions
                    </div>
                <?php endif; ?>
            </div>
                    ...
                    <?php foreach ($login_history as $login): ?>
                        <div class="event-item">
                            ...
                            <?php if ($login['success']): ?>
                                <span style="font-size:0.55rem;color:#10B981;"><i class="fas fa-check-circle"></i></span>
                            <?php else: ?>
                                <span style="font-size:0.55rem;color:#EF4444;"><i class="fas fa-times-circle"></i></span>
                            <?php endif; ?>
                        </div>
                    <?php endforeach; ?>
                <?php else: ?>
                    <div style="text-align:center;padding:12px;color:var(--gray-400);font-size:0.85rem;">
                        <i class="fas fa-history" style="display:block;font-size:1.2rem;margin-bottom:4px;"></i>
                        No login history
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div class="settings-card">
                            ...
                            <div class="event-content">
                                <div class="description">
                                    ...
                                    <?php if (!empty($event['risk_score'])): ?>
                                        <span style="font-size:0.55rem;color:#EF4444;background:#FEF2F2;padding:1px 6px;border-radius:4px;">
                ...
                <?php else: ?>
                    <div style="text-align:center;padding:12px;color:var(--gray-400);font-size:0.85rem;">
                        <i class="fas fa-shield-alt" style="display:block;font-size:1.2rem;margin-bottom:4px;"></i>
                        No security events
                    </div>
                <?php endif; ?>
            </div>
