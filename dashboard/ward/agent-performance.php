...
try {
    $stmt = $db->prepare("
        ...
        GROUP BY u.id, u.first_name, u.last_name, u.email, u.phone, u.status, u.created_at, pu.name, pu.code
        ORDER BY verified_submissions DESC, total_submissions DESC
    ");
    $stmt->execute([$tenant_id, $tenant_id, $tenant_id, $ward_id]);
    ...
    foreach ($agents as $agent) {
        ...
        if ($agent['verified_submissions'] > 0 || $agent['total_submissions'] > 0) {
            $summary['top_performers'][] = $agent;
        }
    }
    
    // Sort top performers
    usort($summary['top_performers'], function($a, $b) {
        return $b['verified_submissions'] - $a['verified_submissions'];
    });
    $summary['top_performers'] = array_slice($summary['top_performers'], 0, 10);
} catch (Exception $e) {
...
.performance-table .rank-badge.gold { background: #FEF3C7; color: #92400E; }
.performance-table .rank-badge.silver { background: #F3F4F6; color: #6B7280; }
.performance-table .rank-badge.bronze { background: #FEF3C7; color: #78350F; }
    ...
    <div class="main-content-inner">
        <div class="performance-container">
            ...
            <?php if (!empty($summary['top_performers'])): ?>
                <h4 style="font-size:0.85rem;font-weight:600;margin:16px 0 8px;">
                ...
                <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(200px,1fr));gap:10px;margin-bottom:20px;">
                    ...
                    ?>
                        <div style="background:white;border-radius:var(--radius);border:1px solid var(--gray-200);padding:12px 16px;text-align:center;">
                            ...
                            <div style="font-size:0.8rem;font-weight:700;color:#10B981;margin-top:4px;">
            ...
            <div class="performance-table-container">
                <table class="performance-table">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td style="text-align:center;font-weight:600;color:var(--gray-400);">
                                    <?php echo $rank++; ?>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td colspan="9">
                                    <div class="empty-state">
                                        ...
                                        <p>No agent performance data available for this period.</p>
                                    </div>
                                </td>
                            </tr>
                        <?php endif; ?>
