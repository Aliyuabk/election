        ...
        <div class="broadcast-header">
            <div>
                ...
                <p style="color: var(--gray-500); margin: 2px 0 0; font-size: 0.85rem;">
                    <?php echo htmlspecialchars($ward_name); ?> Ward • <?php echo number_format($broadcast_stats['total']); ?> broadcasts
                </p>
            </div>
            <div>
                ...
                <div class="broadcast-card">
                    ...
                    <div class="broadcast-actions">
                        ...
                        <?php if ($is_sent): ?>
                            ...
                            <a href="broadcasts-stats.php?id=<?php echo $broadcast['id']; ?>" class="btn-sm view">
