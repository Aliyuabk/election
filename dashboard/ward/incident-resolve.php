<?php
// ============================================================
// WARD COORDINATOR - RESOLVE INCIDENT
// ============================================================
...
try {
    ...
    if ($incident['status'] === 'resolved') {
        header('Location: incidents.php?error=already_resolved');
        exit();
    }
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'resolve') {
        if (empty($resolution_notes)) {
            $error_message = "Please provide resolution notes.";
        } else {
            try {
                $stmt = $db->prepare("
                    UPDATE incidents 
                ...
                ");
                $stmt->execute([$user_id, $resolution_notes, $incident_id, $tenant_id, $ward_id]);
...
.resolve-form .form-group label .required {
    color: #EF4444;
}
.resolve-form .form-group textarea {
    width: 100%;
    padding: 10px 12px;
    border: 1px solid var(--gray-200);
    border-radius: var(--radius);
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="resolve-header">
            <div>
                <h2><i class="fas fa-check-circle"></i> Resolve Incident</h2>
        ...
        <?php if ($incident): ?>
            ...
            <div class="confirm-box">
                ...
                <p>Confirm that this incident has been resolved. Please provide resolution notes below.</p>
            </div>
            ...
            <div class="resolve-form">
                <form method="POST" action="">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn-success" onclick="return confirm('Are you sure you want to mark this incident as resolved?')">
        ...
        <?php else: ?>
            <div style="text-align:center;padding:60px 20px;background:white;border-radius:var(--radius);border:1px solid var(--gray-200);">
                ...
                <p style="color:var(--gray-500);">The incident you're trying to resolve does not exist.</p>
