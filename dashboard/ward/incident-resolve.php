...
// Only allow resolving if status is 'investigating' or 'reported'
if (!in_array($incident['status'], ['investigating', 'reported', 'acknowledged'])) {
    header('Location: incidents.php?error=not_resolvable');
    exit();
}
