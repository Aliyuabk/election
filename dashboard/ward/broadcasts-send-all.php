<?php
// ============================================================
// WARD COORDINATOR - SEND BROADCAST TO ALL
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($message)) {
        ...
        try {
            // Get all recipients in ward
            $recipients = getBroadcastRecipients($tenant_id, 'all', [], $ward_id);
            ...
            logActivity($user_id, 'broadcast_sent_all', "Sent broadcast to all: $title", 'broadcasts', $broadcast_id);
            ...
            error_log("Broadcast send all error: " . $e->getMessage());
        }
    }
}

$page_title = 'Send Broadcast to All';
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="send-header">
            <div>
                <h2><i class="fas fa-bullhorn"></i> Send Broadcast to All</h2>
        ...
        <div class="send-form">
            <form method="POST" action="" id="sendForm">
                ...
                <div class="recipient-info">
                    <i class="fas fa-users"></i> This will be sent to <strong>all users</strong> in this ward.
                </div>

                <div class="form-actions">
                    <button type="submit" class="btn-primary" onclick="return confirm('Send this broadcast to all users?')">
