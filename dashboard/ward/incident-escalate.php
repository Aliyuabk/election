...
// Get LGA coordinators for escalation
$lga_coordinators = [];
try {
    $stmt = $db->prepare("
        ...
        WHERE r.level = 'lga' AND u.lga_id = (SELECT lga_id FROM wards WHERE id = ?)
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($escalation_reason)) {
        ...
        try {
            ...
            $new_notes = $notes . "\n[" . date('Y-m-d H:i:s') . "] ESCALATED to LGA Coordinator: " . $escalation_reason;
            ...
            logActivity($user_id, 'incident_escalated', 
                "Escalated incident #$incident_id to LGA Coordinator - Reason: $escalation_reason",
        ...
        <div class="escalate-container">
            ...
            <div class="escalate-card">
                ...
                <div class="incident-info">
                    <div class="detail-grid">
                        ...
                        <div class="detail-item">
                            ...
                            <span class="value">
                                <?php echo htmlspecialchars($incident['pu_name'] ?? 'N/A'); ?>
                            </span>
                        </div>
                ...
                <div class="warning-box">
                    <i class="fas fa-exclamation-triangle"></i>
                    <strong>Escalation Warning:</strong> Escalating this incident will move it to the LGA Coordinator for review and action.
                </div>
                ...
                <form method="POST" action="">
                    <div class="form-group">
                        ...
                        <select name="escalate_to" required>
                            ...
                            <?php if (empty($lga_coordinators)): ?>
                                <option value="0">No LGA Coordinators available</option>
                            <?php endif; ?>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="escalation_notes" placeholder="Any additional information for the LGA Coordinator..."></textarea>
                    </div>
