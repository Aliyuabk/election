<?php
// ============================================================
// WARD COORDINATOR - INCIDENTS LIST
// ============================================================
...
.incident-card .card-actions .btn-attach {
    background: #F5F3FF;
    color: #8B5CF6;
}

.incident-card .card-actions .btn-attach:hover {
    background: #EDE9FE;
}
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <div class="welcome-section">
            <div>
                ...
                <p class="subtitle">
                    ...
                    <?php echo htmlspecialchars($ward_name); ?> Ward - Incident Management
                </p>
            </div>
            <div class="actions">
        ...
        <div class="filter-bar">
            <select id="puFilter" onchange="applyFilters()">
        ...
        <div class="incident-grid">
            ...
            ?>
                <div class="incident-card">
                    ...
                    <div class="card-actions">
                        ...
                        <?php endif; ?>
                        <a href="incident-attachments.php?id=<?php echo $incident['id']; ?>" class="btn-attach">
            ...
            <?php if (empty($incidents)): ?>
                <div class="empty-state">
                    ...
                    <p>No incidents have been reported in <?php echo htmlspecialchars($ward_name); ?> yet.</p>
