...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($title) || empty($message)) {
        ...
        try {
            // Get observers only
            $recipients = getBroadcastRecipients($tenant_id, 'observers', [], $ward_id);
            $total_recipients = count($recipients);
            
            if ($total_recipients == 0) {
                $error_message = "No observers found in this ward.";
            } else {
                // Insert broadcast
                ...
                logActivity($user_id, 'broadcast_observers', "Sent broadcast to Observers: $title ($total_recipients recipients)", 'broadcasts', $broadcast_id);
                
                $success_message = "Broadcast sent to $total_recipients Observers successfully!";
            ...
            error_log("Broadcast Observers error: " . $e->getMessage());
        }
    }
}
