...
try {
    ...
    $stmt = $db->prepare("SELECT COUNT(*) as count FROM results_ec8b WHERE coordinator_id = ?");
    $stmt->execute([$user_id]);
    $user_stats['ec8b_created'] = (int)($stmt->fetch(PDO::FETCH_ASSOC)['count'] ?? 0);
            ...
            <div class="profile-header">
                ...
                <div class="profile-info" style="flex:1;">
                    ...
                    <div class="role">
                        ...
                        <?php echo htmlspecialchars($user_data['role_name'] ?? 'Ward Coordinator'); ?>
                    </div>
                    <div class="location">
                ...
                <div style="margin-left:auto;">
                    <div class="stats-grid" style="min-width:140px;">
                        <div class="stat-item">
                        ...
                        <div class="stat-item">
                            <div class="number"><?php echo number_format($user_stats['ec8b_created']); ?></div>
                            <div class="label">EC8B</div>
                        </div>
                    </div>
                </div>
            </div>
