<?php
// ============================================================
// LGA COORDINATOR - BROADCAST TO PU AGENTS
// ============================================================
        ...
        <div class="broadcast-container">
            ...
            <div class="welcome-section">
                <div>
                    ...
                    <p class="subtitle">
                        ...
                        <?php echo htmlspecialchars($lga_name); ?> LGA - Send messages to Polling Unit Agents
                    </p>
                </div>
                <div class="actions">
            ...
            <?php if (empty($pu_agents)): ?>
                <div class="alert alert-error" style="text-align:center;padding:30px;">
                    ...
                    <p style="font-size:0.85rem;color:var(--gray-500);">No Polling Unit agents have been assigned in <?php echo htmlspecialchars($lga_name); ?>.</p>
                </div>
            <?php else: ?>
                <form method="POST" action="" id="broadcastForm">
                    ...
                    <div class="form-card">
                        ...
                        <div class="filter-bar">
                            <select id="wardFilter" onchange="filterAgents()">
                        ...
                        <div class="recipient-list" id="recipientList">
                            ...
                            <?php foreach ($pu_agents as $agent): ?>
                                <div class="recipient-item" data-ward="<?php echo $agent['ward_id']; ?>" 
...
// Filter agents by ward and search
function filterAgents() {
    ...
    items.forEach(function(item) {
        var matchWard = !wardFilter || item.dataset.ward === wardFilter;
