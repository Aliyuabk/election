<?php
// ============================================================
// LGA COORDINATOR - CREATE BROADCAST
// ============================================================
...
try {
    ...
    $stmt = $db->prepare("
        ...
        WHERE r.level = 'ward' AND u.lga_id = ? AND u.status = 'active' AND u.deleted_at IS NULL
    ");
    $stmt->execute([$lga_id]);
    ...
    $stmt = $db->prepare("
        ...
        FROM users u 
        JOIN roles r ON u.role_id = r.id 
        WHERE r.level = 'pu_agent' AND u.lga_id = ? AND u.status = 'active' AND u.deleted_at IS NULL
    ");
    $stmt->execute([$lga_id]);
            ...
            <div class="welcome-section">
                <div>
                    ...
                    <p class="subtitle">
                        ...
                        <?php echo htmlspecialchars($lga_name); ?> LGA - Send Messages
                    </p>
                </div>
                <div class="actions">
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="target-options" id="targetOptions">
                            ...
                            <label>
                                <input type="radio" name="target_audience" value="ward" onchange="toggleTargetIds()" />
                                Ward Specific
                            </label>
                            <label>
                    ...
                    <div class="target-ids-section" id="targetIdsSection">
                        <div class="form-group" id="wardTarget">
                    ...
                    <div class="recipient-count">
                        ...
                        <strong id="recipientCount">
                            <?php echo number_format($ward_coordinators_count + $pu_agents_count); ?>
                        </strong>
