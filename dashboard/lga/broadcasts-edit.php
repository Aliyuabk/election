<?php
// ============================================================
// LGA COORDINATOR - EDIT BROADCAST
// ============================================================
...
// Get wards for target selection
$wards = [];
try {
            ...
            <div class="welcome-section">
                <div>
                    ...
                    <p class="subtitle">
                        ...
                        <?php echo htmlspecialchars($lga_name); ?> LGA - Edit Broadcast
                    </p>
                </div>
                <div class="actions">
                ...
                <div class="form-card">
                    ...
                    <div class="form-group">
                        ...
                        <div class="target-options" id="targetOptions">
                            ...
                            <label <?php echo $broadcast['target_audience'] === 'ward' ? 'class="selected"' : ''; ?>>
                                <input type="radio" name="target_audience" value="ward" <?php echo $broadcast['target_audience'] === 'ward' ? 'checked' : ''; ?> onchange="toggleTargetIds()" />
                                Ward Specific
                            </label>
                    ...
                    <div class="target-ids-section <?php echo in_array($broadcast['target_audience'], ['ward', 'role_specific']) ? 'active' : ''; ?>" id="targetIdsSection">
                        <div class="form-group" id="wardTarget" style="<?php echo $broadcast['target_audience'] === 'ward' ? 'display:block;' : 'display:none;'; ?>">
                            ...
                            <select name="target_ids[]" multiple>
                                ...
                                ?>
                                    <option value="<?php echo $ward['id']; ?>" <?php echo in_array($ward['id'], $selected_ids) ? 'selected' : ''; ?>>
                        ...
                        <div class="form-group" id="roleTarget" style="<?php echo $broadcast['target_audience'] === 'role_specific' ? 'display:block;' : 'display:none;'; ?>">
                            ...
                            <select name="target_ids[]" multiple>
                                <?php 
                                    $role_options = ['ward' => 'Ward Coordinators', 'pu_agent' => 'PU Agents'];
...
function toggleTargetIds() {
    ...
    var wardTarget = document.getElementById('wardTarget');
    var roleTarget = document.getElementById('roleTarget');
    
    if (selected) {
        if (selected.value === 'ward' || selected.value === 'role_specific') {
            section.classList.add('active');
            if (selected.value === 'ward') {
                wardTarget.style.display = 'block';
                roleTarget.style.display = 'none';
            } else {
                wardTarget.style.display = 'none';
