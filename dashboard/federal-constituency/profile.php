<?php
// ============================================================
// FEDERAL CONSTITUENCY COORDINATOR - PROFILE
// ============================================================
        ...
        <div class="profile-header">
            ...
            <div class="profile-info">
                ...
                <span class="role-badge">
                    ...
                    <?php echo htmlspecialchars($user['role_name'] ?? 'Federal Constituency Coordinator'); ?>
                </span>
                <div class="email">
                ...
                <div class="location">
                    ...
                    <?php 
                        $location = [];
                        if (!empty($user['federal_constituency_name'])) $location[] = $user['federal_constituency_name'];
        ...
        <div class="profile-grid">
            ...
            <div class="profile-card">
                ...
                <div class="info-row">
                    ...
                    <span class="value"><?php echo htmlspecialchars($user['federal_constituency_name'] ?? 'Not assigned'); ?></span>
                </div>
                <div class="info-row">
            ...
            <div class="profile-card">
                ...
                <div class="quick-actions">
                    ...
                    <a href="change-password.php" class="quick-action">
                        <i class="fas fa-key"></i> Change Password
                    </a>
                    <a href="profile-activity.php" class="quick-action">
                        <i class="fas fa-history"></i> Activity Log
                    </a>
                    <a href="profile-security.php" class="quick-action">
