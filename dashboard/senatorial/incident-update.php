<?php
// ============================================================
// SENATORIAL COORDINATOR - UPDATE INCIDENT STATUS
// ============================================================
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($status)) {
        ...
        try {
            ...
            ");
            $stmt->execute([$status, $resolved_at, $resolved_by, $notes, $incident_id, $tenant_id]);
            
            logActivity($user_id, 'incident_updated', "Updated incident: {$incident['title']} status to $status (ID: $incident_id)");
            
            $_SESSION['flash_success'] = 'Incident status updated successfully!';
    ...
    <div class="main-content-inner">
        ...
        <div class="form-container">
            <div class="form-title">
                <i class="fas fa-exclamation-triangle"></i> Update Incident
            </div>
            <div class="form-subtitle">
                Update the status of "<?php echo htmlspecialchars($incident['title']); ?>"
            </div>

            <div class="current-status">
                <div class="label">Current Status</div>
                <div class="value">
                    <span class="status-badge <?php echo $incident['status']; ?>" style="display:inline-block;padding:2px 12px;border-radius:20px;font-size:0.75rem;font-weight:600;background:#FEE2E2;color:#DC2626;">
            ...
            <form method="POST" action="">
                <div class="form-group">
                    <label for="status">New Status <span class="required" style="color:var(--danger);">*</span></label>
                ...
                <div class="form-group">
                    ...
                    <textarea name="notes" id="notes" placeholder="Add notes about this update..."></textarea>
                </div>
