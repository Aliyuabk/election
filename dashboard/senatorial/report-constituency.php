<?php
// ============================================================
// SENATORIAL COORDINATOR - FEDERAL CONSTITUENCY REPORT
// ============================================================
...
// GET FILTERS
// ============================================================
$constituency_id = isset($_GET['constituency']) ? (int)$_GET['constituency'] : 0;
$election_id = isset($_GET['election']) ? (int)$_GET['election'] : 0;

// ============================================================
// GET ELECTIONS AND CONSTITUENCIES
// ============================================================
$elections = [];
$constituencies = [];
try {
...
$page_title = 'Federal Constituency Report';
        ...
        <?php if ($constituency_id > 0 && $election_id > 0 && $report_data): ?>
            ...
            <div class="section-card">
                <div class="card-header">
                    <h3><i class="fas fa-map-marker-alt" style="color:var(--primary);margin-right:6px;"></i> LGA Breakdown</h3>
                    <span style="font-size:0.75rem;color:var(--gray-400);"><?php echo count($lga_data); ?> LGAs</span>
                </div>
