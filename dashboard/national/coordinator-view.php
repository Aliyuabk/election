<?php
// ============================================================
// NATIONAL COORDINATOR - VIEW COORDINATOR DETAILS
// ============================================================
...
try {
    ...
    $stmt = $db->prepare("SELECT COUNT(*) as count FROM results_ec8a WHERE agent_id = ?");
    $stmt->execute([$coordinator_id]);
    $stats['submissions'] = $stmt->fetchColumn() ?? 0;
    ...
    // Get checkins
    $stmt = $db->prepare("SELECT COUNT(*) as count FROM agent_checkins WHERE agent_id = ?");
    $stmt->execute([$coordinator_id]);
    ...
    <div class="main-content-inner">
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:12px;margin-top:8px;">
                <div>
                    <h2 style="font-size:1.5rem;font-weight:700;margin:0;">
                        ...
                        <span style="font-size:0.7rem;background:<?php echo ($coordinator['status'] ?? '') === 'active' ? '#10B981' : '#6B7280'; ?>;color:white;padding:2px 12px;border-radius:20px;font-weight:500;margin-left:8px;">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo number_format($stats['submissions'] ?? 0); ?></div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-number"><?php echo number_format($stats['incidents_reported'] ?? 0); ?></div>
