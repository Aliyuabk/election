<?php
// ============================================================
// NATIONAL COORDINATOR - EDIT POLLING UNIT
// ============================================================
                            ...
                            <select name="state_id" class="form-control" id="stateSelect"
                                ...
                                <?php foreach ($states as $state): ?>
                                    <option value="<?php echo $state['id']; ?>" 
                                        <?php echo $pu_data['state_id'] == $state['id'] ? 'selected' : ''; ?>>
                ...
                fetch('ajax-get-lgas.php?state_id=' + stateId)
                    ...
                    .then(data => {
                        ...
                        data.forEach(function(lga) {
                            var selected = (lga.id == currentLgaId) ? 'selected' : '';
                            lgaSelect.innerHTML += '<option value="' + lga.id + '" ' + selected + '>' + lga.name + '</option>';
                        });
                        // Trigger LGA change to load wards
