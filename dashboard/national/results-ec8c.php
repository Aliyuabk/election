<?php
// ============================================================
// NATIONAL COORDINATOR - EC8C RESULTS (LGA)
// ============================================================
...
try {
    ...
    if (!empty($search)) {
        $where_clauses[] = '(l.name LIKE ? OR u.full_name LIKE ?)';
        $params[] = "%$search%";
        $params[] = "%$search%";
    }
    ...
    // Count total
    $count_stmt = $db->prepare("SELECT COUNT(*) FROM results_ec8c r WHERE $where_sql");
    ...
    error_log("EC8C Results Error: " . $e->getMessage());
}
...
$page_title = 'EC8C Results';
$page_subtitle = 'LGA Collation Forms';
?>
    ...
    <div class="main-content-inner">
        ...
        <div class="welcome-section">
            <div class="breadcrumb">
                ...
                <i class="fas fa-chevron-right" style="font-size:0.6rem;color:var(--gray-400);"></i>
                <span style="font-weight:600;color:var(--gray-800);">EC8C</span>
            </div>
            ...
            <div style="display:flex;justify-content:space-between;align-items:flex-start;flex-wrap:wrap;gap:12px;margin-top:8px;">
                <div>
                    ...
                    <p style="color:var(--gray-500);margin:2px 0 0;">
                        ...
                        LGA Collation Forms • <?php echo number_format($total_results); ?> records
                    </p>
                </div>
                <div style="display:flex;gap:8px;flex-wrap:wrap;">
                    ...
                    <a href="reports.php?type=ec8c" class="btn-primary" style="padding:8px 16px;background:var(--primary);color:white;border:none;border-radius:10px;text-decoration:none;font-weight:600;font-size:0.8rem;display:inline-flex;align-items:center;gap:6px;">
        ...
        <div class="stats-grid">
            <div class="stat-card">
                ...
                <div class="stat-label">Total EC8C</div>
            ...
            <form method="GET" action="" style="display:flex;flex-wrap:wrap;gap:10px;align-items:center;">
                <div style="flex:1;min-width:150px;">
                    <div class="search-box" style="width:100%;">
                        ...
                        <input type="text" name="search" placeholder="Search LGA or coordinator..." value="<?php echo htmlspecialchars($search); ?>" />
                    </div>
                </div>
                ...
                <?php if (!empty($search) || !empty($status_filter) || $state_filter > 0): ?>
                    <a href="results-ec8c.php" class="btn-reset" style="padding:6px 12px;background:var(--gray-100);color:var(--gray-600);border:none;border-radius:8px;font-family:'Inter',sans-serif;font-weight:500;font-size:0.75rem;cursor:pointer;text-decoration:none;transition:var(--transition);">
        ...
        <div style="background:white;border-radius:var(--radius);overflow:hidden;border:1px solid var(--gray-200);">
                ...
                <div style="overflow-x:auto;">
                    <table style="width:100%;border-collapse:collapse;font-size:0.75rem;">
                        <thead style="background:var(--gray-50);border-bottom:2px solid var(--gray-200);">
                            <tr>
                                <th style="padding:8px 12px;text-align:left;font-weight:600;color:var(--gray-600);">LGA / Coordinator</th>
                                <th style="padding:8px 12px;text-align:center;font-weight:600;color:var(--gray-600);">State</th>
                            ...
                            ?>
                                <tr style="border-bottom:1px solid var(--gray-100);transition:var(--transition);hover:background:var(--gray-50);">
                                    <td style="padding:8px 12px;">
                                        <div style="font-weight:500;font-size:0.8rem;"><?php echo htmlspecialchars($result['lga_name'] ?? 'Unknown LGA'); ?></div>
                                    ...
                                    <td style="padding:8px 12px;text-align:center;font-size:0.7rem;">
                                        <?php echo htmlspecialchars($result['state_name'] ?? 'Unknown'); ?>
                                    </td>
                                    ...
                                    <td style="padding:8px 12px;text-align:center;">
                                        <div style="display:flex;gap:3px;justify-content:center;flex-wrap:wrap;">
                                            <a href="result-view.php?type=ec8c&id=<?php echo $result['id']; ?>" class="btn-sm" style="padding:2px 8px;border-radius:4px;background:var(--primary);color:white;text-decoration:none;font-size:0.6rem;" title="View">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <?php if ($result['status'] === 'pending'): ?>
                                                <a href="ec8c-verify.php?id=<?php echo $result['id']; ?>" class="btn-sm" style="padding:2px 8px;border-radius:4px;background:#10B981;color:white;text-decoration:none;font-size:0.6rem;" title="Verify">
            ...
            <?php else: ?>
                <div style="padding:40px 20px;text-align:center;color:var(--gray-500);">
                    ...
                    <p style="font-size:0.85rem;">No EC8C results found.</p>
                </div>
            <?php endif; ?>
        </div>
