<?php
// ============================================================
// STATE COORDINATOR - UPLOAD EC8B FORM
// ============================================================
...
if ($ward_id > 0) {
    try {
        ...
        if ($result) {
            ...
            $location_name = "$ward_name ($lga_name)";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Build party votes JSON
    $party_votes_json = json_encode(array_filter($party_votes, function($v) { return $v > 0; }));
                    ...
                    <div style="margin-bottom:16px;">
                        ...
                        <div style="margin-bottom:8px;">
                            ...
                            <div style="padding:8px 12px;background:var(--gray-50);border-radius:8px;border:1px solid var(--gray-200);">
                                ...
                                <div style="font-weight:500;color:var(--gray-700);"><?php echo htmlspecialchars($state_name); ?></div>
                            </div>
                        </div>
