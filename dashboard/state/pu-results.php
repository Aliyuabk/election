<?php
// ============================================================
// STATE COORDINATOR - POLLING UNIT RESULTS
// ============================================================
...
<main class="main-content">
    ...
    <div class="main-content-inner">
        ...
        <!-- Filters -->
        <div style="background:white;border-radius:var(--radius);padding:10px 14px;margin-bottom:14px;border:1px solid var(--gray-200);">
            <form method="GET" action="" style="display:flex;flex-wrap:wrap;gap:8px;align-items:center;">
                ...
                <div style="flex:1;min-width:150px;">
                    <div class="search-box" style="width:100%;">
                        ...
                        <input type="text" name="search" placeholder="Search agent..." value="<?php echo htmlspecialchars($search); ?>" />
                    </div>
                </div>
                
                <div style="min-width:120px;">
                    <select name="status" class="form-select" style="width:100%;padding:6px 10px;border:1px solid var(--gray-200);border-radius:8px;font-family:'Inter',sans-serif;font-size:0.7rem;background:white;">
                ...
                <?php if (!empty($search) || !empty($status_filter)): ?>
                    <a href="pu-results.php?id=<?php echo $pu_id; ?>" class="btn-reset" style="padding:6px 10px;background:var(--gray-100);color:var(--gray-600);border:none;border-radius:8px;font-family:'Inter',sans-serif;font-weight:500;font-size:0.7rem;cursor:pointer;text-decoration:none;transition:var(--transition);">
