<?php
// ============================================================
// STATE COORDINATOR - RESET COORDINATOR PASSWORD
// ============================================================
        ...
        <form method="POST" action="" style="background:white;border-radius:var(--radius);padding:24px;border:1px solid var(--gray-200);">
            ...
            <div style="background:var(--gray-50);border-radius:8px;padding:12px 16px;margin-bottom:20px;border:1px solid var(--gray-200);">
                <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(150px,1fr));gap:8px;">
                    ...
                    <div>
                        <label style="display:block;font-size:0.6rem;color:var(--gray-400);text-transform:uppercase;letter-spacing:0.03em;">Jurisdiction</label>
                        <div style="font-weight:500;font-size:0.85rem;"><?php echo htmlspecialchars($coordinator['jurisdiction_name']); ?></div>
                    </div>
                </div>
            </div>
