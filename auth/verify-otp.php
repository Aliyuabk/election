...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 480px) { .login-card { padding: 32px 24px; } .otp-input-group input { width: 40px; height: 48px; font-size: 1.2rem; } }
    </style>
</head>
<body>
<div class="login-wrapper">
    <div class="login-card">
        ...
        <p class="subtitle" style="color: #64748B; margin-bottom: 20px;">Enter the 6-digit code sent to your email.</p>
